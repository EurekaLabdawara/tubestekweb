...
<body>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Case bumper merupakan case dengan desain simple mengelilingi sisi samping gadget, sehingga desain asli gadget tetap terlihat.</p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Case Wooden merupakan case dari bahan kayu asli yang didalamnya terdapat bantalan halus untuk melindungi handphone.</p>
    </div>
    <div class="card-footer">
      <a href="#" class="card-link">Yuk Custom..</a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Case Flip merupakan case yang menutup bagian belakang sekaligus bagian depan sehingga berperan sebagai pelindung layar.</p>
    </div>
    <div class="card-footer">
      <a href="#" class="card-link">Yuk Custom..</a>
    </div>
  ...
  <div class="card">
    ...
    $(document).ready(function() {
		...
		$("#btnKatCaseHP").click(function() {
			$('html, body').animate({ scrollTop: $("#CaseHPSection").offset().top }, 2000);
		});
		
		$("#btnKatBaju").click(function() {
			$('html, body').animate({ scrollTop: $("#BajuSection").offset().top }, 2000);
		});
    });
    </script>
