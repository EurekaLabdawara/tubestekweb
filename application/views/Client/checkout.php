        ...
        <div class="mt-3 col-12 ">
            ...
            <div class="row">
                <div class="col-6 left-basket-container">
                    ...
                    <div class="address-wrapper-box address-wrapper-box--problematic single-address-wrapper chosen-address-receiver-area hopscotch-focus"
                        id="chosen-single-address-heading-card">
                            ...
                            <div class="flex-wrapper">
                                <div class="left-wrapper">
                                    ...
                                    <span class="address-detail street">
                                        Jl. Adhyaksa III No.3 Rt3/Rw5 , kec.Dayeuh kolot, Desa sukapura Bandung
                                        Buahbatu, Jawa Barat
                                    </span><br>
                                    ...
                                    <input type="hidden" class="input-address-street"
                                        value="Jl. Adhyaksa III No.3 Rt3/Rw5 , kec.Dayeuh kolot, Desa sukapura Bandung Buahbatu, Jawa Barat">
                                    ...
                                    <input type="hidden" class="input-district-name"
                                        value="Jawa Barat,Kota Bandung,Bandung">
                                </div>
                                ...
                                <div class="pin-point-wrapper ">
                                    <div class="pin-point-result-wrapper filled" id="single-address-heading-pinpoint">
                                        <div class="padder bg--cv-cc-nr">
                                            ...
                                            <input type="hidden" class="input-lat-lng"
                                                value="-6.96746190303793,107.63429448008536">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="address-box-bottom-btns-wrapper">
                                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Gunakan Alamat
                                    Baru</button>
                                <input type="hidden" id="is-one-click-shipment" value="0">
                                <input type="hidden" id="is-multiple" value="0">
                                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Pilih Alamat
                                    Lain</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6 left-basket-container">
                    <div class="col px-md-5">
                        <div class="p-3 border bg-light">
                            ...
                            <hr class="my-4">
                            <h7> alamat 1<button class="btn btn-outline-success my-2 my-sm-0" type="submit"
                                    style="float:right">Pilih Alamat
                                </button></h7>
                            <hr class="my-4">
                            <h7> alamat 2<button class="btn btn-outline-success my-2 my-sm-0" type="submit"
                                    style="float:right">Pilih Alamat</button></h7>
                            <hr class="my-4">
                            <h7> alamat 3<button class="btn btn-outline-success my-2 my-sm-0" type="submit"
                                    style="float:right">Pilih Alamat</button></h7>
                        </div>
                    </div>
                </div>
